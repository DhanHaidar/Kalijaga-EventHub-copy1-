    ...
    <div class="container-fluid mt-5">
      <div class="row">
        ...
        <div class="col-12 col-sm-8 mb-3">
          ...
          <div class="col-12">
            <div class="row">
              <div v-for="event in filteredEvents" class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
...
export default {
  ...
  methods: {
    ...
    deleteEvent(id) {
      ...
      axios
        .delete(`http://localhost/Suka-projek/Kalijaga-EventHub-copy1-/public/api/event/${id}`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
        })
